...
const Sub_detail = () => {
    return (
        <div>
            <p className='title_name'> 쿨맥스 브이넥 반팔 니트 [블랙] <span>Coolmax V-neck short-sleeve knit [Black]</span></p>
        <div className="sub_box flex">

        <div className="img-box">
            <img src="https://image.msscdn.net/images/goods_img/20220601/2594411/2594411_1_500.jpg?t=20220601075542" alt="" />
        </div>

      <div className="product-text">
      <div className="text-wrap">
        <h2>Product Info <span>제품정보</span></h2>
        <div className="text-box1 flex">
          ...
          <div className="text2">
            ...
            <p className="p4">★★★★★ <span>4.7</span></p>
          </div>
        </div>
      </div>
      <hr />
      <div className="price-wrap">
        ...
        <div className="text-box1 flex">
          ...
          <div className="text2">
            ...
            <p className="p2"> 36,019 ~ 39,800원 <br />
                <div className="coupon-btn"><Link to="#">쿠폰받기</Link></div></p>
      ...
      <div className="buy-btn-box flex">
        ...
        <div className="heart"><FavoritCheck /></div>
